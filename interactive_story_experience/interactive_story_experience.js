...
function showKitchenMomScreen() {
    document.getElementById("kitchen-mom-overlay").style.display = "block";
}

function hideKitchenMomScreen() {
    document.getElementById("kitchen-mom-overlay").style.display = "none";
}
...
function showChapterScreen(chapterNumber) {
  ...
  if (chapterNumber === 2) {
    ...
    const kitchenMomScreen = document.getElementById("kitchen-mom-overlay");
  ...
  if (message.speaker === '@jake') {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            document.getElementById("defeat-screen").style.display = "block";
            document.getElementById("defeat-screen").style.opacity = "0";
            ...
            document.querySelector(".name-tag").innerText = "Valorian";
            document.getElementById("dialogue").textContent = "[You lost.]";
            updateNameTagStyling();
            
            // Fade in the defeat screen and dialogue
            setTimeout(() => {
                document.getElementById("defeat-screen").classList.add("animate__animated", "animate__fadeIn");
                document.querySelector(".dialogue-container").classList.add("animate__animated", "animate__fadeIn");
                document.getElementById("defeat-screen").style.opacity = "1";
            ...
            setTimeout(() => {
                ...
                document.getElementById("defeat-screen").classList.remove("animate__fadeIn");
...
function animatePlayerDMMessage(text, callback) {
  ...
  function typeCharacter() {
    if (i < text.length) {
      dmInputBox.textContent += text.charAt(i);
      i++;
      setTimeout(typeCharacter, typingSpeed);
    } else {
      setTimeout(() => {
        // Clear the input box after animation completes
        dmInputBox.textContent = '';
